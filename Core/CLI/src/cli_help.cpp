...
void initdocstrings()
{
	...
	;
	docstrings["saveAgentState"] =
		"Saves the complete agent state to a protobuf file.\n"
		"\n"
		"Synopsis\n"
		"\n"
		"  saveAgentState <filename>\n"
		"\n"
		"Description\n"
		"\n"
		"The saveAgentState command serializes the entire agent state, including\n"
		"working memory, productions, preferences, and other internal structures,\n"
		"to a binary protobuf file. This provides a complete snapshot that can be\n"
		"used to rebuild an equivalent agent later.\n"
		"\n"
		"Usage\n"
		"\n"
		"  saveAgentState myagent.pb\n"
		"\n"
		"See Also\n"
		"\n"
		"loadAgentState\n"
	;
	docstrings["loadAgentState"] =
		"Loads the complete agent state from a protobuf file.\n"
		"\n"
		"Synopsis\n"
		"\n"
		...
		"Description\n"
		"\n"
		"The loadAgentState command deserializes the agent state from a binary\n"
		"protobuf file created by saveAgentState. This rebuilds the saved state\n"
		"into the current agent shell so it behaves like the snapshotted agent\n"
		"from that point forward.\n"
		"\n"
		"Usage\n"
		"\n"
		"  loadAgentState myagent.pb\n"
		"\n"
		"See Also\n"
		"\n"
		"saveAgentState\n"
	;
	docstrings["saveKernelState"] =
		"Saves kernel settings and all kernel-visible agents to a protobuf file.\n"
		"\n"
		"Synopsis\n"
		"\n"
		"  saveKernelState <filename>\n"
		"\n"
		"Description\n"
		"\n"
		"The saveKernelState command serializes the current kernel settings and\n"
		"every agent currently registered with the kernel into a binary protobuf\n"
		"file. This captures the kernel's view of the runtime without rebuilding\n"
		"the kernel object itself.\n"
		"\n"
		"Usage\n"
		"\n"
		"  saveKernelState session.pb\n"
		"\n"
		"See Also\n"
		"\n"
		"loadKernelState\n"
	;
	docstrings["loadKernelState"] =
		"Loads kernel settings and all kernel-visible agents from a protobuf file.\n"
		"\n"
		"Synopsis\n"
		"\n"
		"  loadKernelState <filename>\n"
		"\n"
		"Description\n"
		"\n"
		"The loadKernelState command deserializes a protobuf file created by\n"
		"saveKernelState, reconciles the agents currently known to the kernel,\n"
		"and restores each saved agent into its kernel-visible shell.\n"
		"\n"
		"Usage\n"
		"\n"
		"  loadKernelState session.pb\n"
		"\n"
		"See Also\n"
		"\n"
		"saveKernelState\n"
